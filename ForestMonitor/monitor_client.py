...
import datetime
import argparse
from monitor_server import SEND_REQUEST, STOP_REQUEST
...
def run_client(sensor_id = 0, amount_of_messages=5000):
    ...
    while messages < amount_of_messages:
        try:
            ...
            bytes=b''
            CAM_DATA = {"sensor_id": sensor_id, "timestamp":str(ts),  "status":random.randint(0, 10), "is_sending_image":is_sending}
